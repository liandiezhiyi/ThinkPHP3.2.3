...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>编辑账户</strong></div>
  ...
  $(function(){
    ...
    <form method="post" class="form-x" action="<?php echo U('Rule/updateUser');?>">  
     ...
     <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo ($user_data['master_username']); ?>" readOnly name="username" data-validate="required:请输入账户" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
         <input type="text" class="input w50" value="<?php echo ($user_data['master_nickname']); ?>" name="nickname" data-validate="required:请输入昵称" />
        </div>
      </div>     
      <div class="form-group">
        <div class="label">
