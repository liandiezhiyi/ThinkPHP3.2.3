  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<?php echo U('Tablet/addClassify');?>"> 新增分类</a> </li>
        <li>搜索：</li>  
        <form action="<?php echo U('Tablet/classsifySearch');?>" method="GET">
	        <li>
    ...
    <form action="<?php echo U('Tablet/delClassifies');?>" method="POST" id="listform">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td width="10%"><?php echo ($vo["classify_info"]); ?></td>          
          
          <td><div class="button-group"> <a class="button border-main" href="<?php echo U('Tablet/updateClassify',array('id'=>$vo['id']));?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="<?php echo U('Tablet/delClassify',array('id'=>$vo['id']));?>"" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
