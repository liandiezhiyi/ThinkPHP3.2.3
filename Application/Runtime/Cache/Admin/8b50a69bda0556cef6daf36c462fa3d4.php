...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" onsubmit=" return ss()" action="<?php echo U('Tablet/updateProduct');?>" enctype="multipart/form-data">  
 	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?><input type="hidden" name="uid" value="<?php echo ($va["id"]); ?>">
	        ...
	        <div class="field">
	        			 <select name="class_id"  id="class_id"  class="input w50 "  >
							<option value="0" selected="selected">请选择</option>
	                        	<?php if(is_array($classify_id)): $i = 0; $__LIST__ = $classify_id;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $va['product_classify']): ?>selected="selected"<?php endif; ?> ><?php echo ($vo["classify_name"]); ?>   </option><?php endforeach; endif; else: echo "" ;endif; ?>
	                        </select> 
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo ($va['product_name']); ?>"  name="product_name" data-validate="required:请输商品名称" />
          <div class="tips"></div>
        </div>
      </div>
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo ($va['product_price']); ?>"  name="product_pric" data-validate="required:请输商品价格" />
          <div class="tips"></div>
        </div>
      </div>
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo ($va['product_num']); ?>"  name="product_num" data-validate="required:请输商品库存" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <textarea rows="20" cols="20" id="editor_content"  name="product_info" style="display:none" ><?php echo ($va["product_info"]); ?></textarea>
  ...
  <div class="form-group">
        ...
        <div class="field ">      
         <input type="text" class="input w50" value="<?php echo ($va['product_img']); ?>" name="product_img" placeholder="输入网络图片地址"  />
         <dd  class="mselector">
