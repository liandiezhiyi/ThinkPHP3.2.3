...
<div id="winpop">
 ...
 <div class="con1"></div>
  ...
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 用户组管理</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o " href="<?php echo U('Rule/AddGroup');?>"   data-reveal-id="myModal"> 新增用户组</a> </li>
        <li>搜索：</li>  
        <form action="<?php echo U('Rule/GroupSearch');?>" method="GET">
	        <li>
	          <input type="text" placeholder="用户组" name="keywords" value="<?php echo ($key); ?>" class="input" style="width:250px; line-height:17px;display:inline-block" />
	          <button  class="button border-main icon-search"  > 搜索</button>
	        </li>
     </form>   
      </ul>
    </div>
    <form action="<?php echo U('Rule/delGroups');?>" method="POST" id="listform">

    <table class="table table-hover text-center grouptable">
      <tr>
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <a class="button border-main" href="<?php echo U('Rule/RuleGroup',array('id'=>$vo['id']));?>">分配权限</a>
          <a  data-reveal-id="myModal1" class="moduser button border-main" href="<?php echo U('Rule/updateGroup',array('id'=>$vo['id']));?>"> <span class="icon-edit"></span> 修改</a> 
          <a class="button border-red" href="<?php echo U('Rule/delGroup',array('id'=>$vo['id']));?>" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
