...
<div id="winpop">
 ...
 <div class="con1"></div>
  ...
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 供应商管理</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<?php echo U('Warehouse/addSupplier');?>"> 新增供应商</a> </li>
        <li>搜索：</li>  
        <form action="<?php echo U('Warehouse/SupplierSearch');?>" method="GET">
	        <li>
	          <input type="text" placeholder="供应商名称" name="keywords" value="<?php echo ($key); ?>" class="input" style="width:250px; line-height:17px;display:inline-block" />
	          <button  class="button border-main icon-search"  > 搜索</button>
	        </li>
     </form>  
      </ul>
    </div>
    <form action="<?php echo U('Warehouse/delSuppliers');?>" method="POST" id="listform">
    <table class="table table-hover text-center">
      <tr>
        <th width="100" style="text-align:left; padding-left:20px;">ID</th>
        <th width="20%">供应商名称</th>
        <th width="20%">联系电话</th>    
        <th width="20%">供应商信息</th>                  
        <th width="310">操作</th>
      </tr>
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td><?php echo ($vo["supplier_phone"]); ?></td>     
          <td width="20%"><?php echo ($vo["supplier_info"]); ?></td>                   
          <td><div class="button-group"> <a class="button border-main" href="<?php echo U('Warehouse/updateSupplier',array('id'=>$vo['id']));?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="<?php echo U('Warehouse/delSupplier',array('id'=>$vo['id']));?>"" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
