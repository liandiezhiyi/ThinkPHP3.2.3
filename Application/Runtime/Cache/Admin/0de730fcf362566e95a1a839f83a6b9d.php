...
<div id="winpop">
 ...
 <div class="con1"></div>
  ...
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 档案分类</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<?php echo U('Oa/addOaclass');?>"> 新增分类</a> </li>
        <li>搜索：</li>  
        <form action="<?php echo U('Oa/OaclassSearch');?>" method="GET">
	        <li>
    ...
    <form action="<?php echo U('Oa/delOaclasses');?>" method="POST" id="listform">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>" />
           <?php echo ($vo["id"]); ?></td>
          <td width="10%">
          <img width="35%" src="<?php echo ($vo["oaclasses_url"]); ?>">
          </td>   
          <td><?php echo ($vo["oaclasses_name"]); ?></td>     
          <td width="10%"><?php echo ($vo["oaclasses_info"]); ?></td>     
          <td><div class="button-group"> <a class="button border-main" href="<?php echo U('Oa/updateOaclass',array('id'=>$vo['id']));?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="<?php echo U('Oa/delOaclass',array('id'=>$vo['id']));?>" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
