...
<div id="winpop">
 ...
 <div class="con1"></div>
  ...
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 区域管理</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<?php echo U('Warehouse/addWarehouseClass');?>"> 新增区域</a> </li>
        <li>搜索：</li>  
        <form action="<?php echo U('Warehouse/WarehouseClassSearch');?>" method="GET">
	        <li>
	          <input type="text" placeholder="区域名称" name="keywords" value="<?php echo ($key); ?>" class="input" style="width:250px; line-height:17px;display:inline-block" />
	          <button  class="button border-main icon-search"  > 搜索</button>
	        </li>
     </form>  
      </ul>
    </div>
    <form action="<?php echo U('Warehouse/delWarehouseClasses');?>" method="POST" id="listform">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>" />
           <?php echo ($vo["id"]); ?></td>
          <td><?php echo ($vo["warehouseclass_name"]); ?></td>
          <td width="10%"><?php echo ($vo["warehouseclass_info"]); ?></td>                     
          <td><div class="button-group"> <a class="button border-main" href="<?php echo U('Warehouse/updateWarehouseClass',array('id'=>$vo['id']));?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="<?php echo U('Warehouse/delWarehouseClass',array('id'=>$vo['id']));?>"" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
