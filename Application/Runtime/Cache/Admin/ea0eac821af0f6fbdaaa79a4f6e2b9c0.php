  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o " href="<?php echo U('Basic/addCompany');?>"   data-reveal-id="myModal"> 新增证明单位</a> </li>
        <li>搜索：</li>  
        <form action="<?php echo U('Basic/CompanySearch');?>" method="GET">
	        <li>
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td><div class="button-group"><a  data-reveal-id="myModal1" class="moduser button border-main" href="<?php echo U('Basic/updateCompany',array('id'=>$vo['id']));?>"><input type="hidden" class="id" name="0" value="<?php echo ($vo["id"]); ?>"> <span class="icon-edit"></span> 修改</a> <a class="button border-red" href="<?php echo U('Basic/delCompany',array('id'=>$vo['id']));?>"" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
...
<div id="myModal" class="reveal-modal">
	...
	<form method="post"  class="form-x" action="<?php echo U('Basic/addCompany');?>">
...
<div id="myModal1" class="reveal-modal">
	...
	<form method="post"  class="form-x" action="<?php echo U('Basic/updateCompany');?>">
