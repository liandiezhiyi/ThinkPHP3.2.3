...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>新增历史发展</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" onsubmit=" return ss()" action="<?php echo U('Oa/addhistory');?>" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value=""  name="history_title" data-validate="required:请输发展标题" />
          <div class="tips"></div>
        </div>
      </div>
        <div class="form-group">
            ...
            <div class="field">
                <input type="text" class="input w50" value=""  name="history_des" data-validate="required:请输入摘要" />
                <div class="tips"></div>
            </div>
        </div>
      ...
      <div class="form-group">
        ...
        <textarea rows="20" cols="20" id="editor_content" name="history_content" style="display:none;"></textarea>
         <script>
