  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<?php echo U('Oa/addhistory');?>"> 新增历史发展</a> </li>
        <li>搜索：</li>  
        <form action="<?php echo U('Oa/historySearch');?>" method="POST">
	        <li>
	          <input type="text" placeholder="请输入发展标题" name="keywords" value="<?php echo ($key); ?>" class="input" style="width:250px; line-height:17px;display:inline-block" />
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>" />
           <?php echo ($vo["id"]); ?></td>
          <td>
          <img width="40px" height="40px" src="<?php echo ($vo["history_url"]); ?>"/>
          
          </td>
          <td width="10%"><?php echo ($vo["history_title"]); ?></td>
           <td width="10%"><?php echo ($vo["history_des"]); ?></td>
          <td ><!-- <?php echo (mb_substr($vo["product_info"],0,20,'utf-8')); ?> -->  <a href="<?php echo U('Oa/more',array('id'=>$vo['id']));?>" target="view_window"><span id="more">详情查看</span></a></td>

          
          <td><div class="button-group"> <a class="button border-main" href="<?php echo U('Oa/updatehistory',array('id'=>$vo['id']));?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="<?php echo U('Oa/delhistory',array('id'=>$vo['id']));?>" " onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
