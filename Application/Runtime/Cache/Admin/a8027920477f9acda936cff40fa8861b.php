...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" onsubmit=" return ss()"  action="<?php echo U('Tablet/addProduct');?>" enctype="multipart/form-data">  
	        ...
	        <div class="field">
	        			 <select name="class_id"  onblur="ss()" id="class_id"  class="input w50 "  >
							<option value="0" selected="selected">请选择</option>
	                        	<?php if(is_array($classify_id)): $i = 0; $__LIST__ = $classify_id;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["classify_name"]); ?>   </option><?php endforeach; endif; else: echo "" ;endif; ?>
	                        </select> 
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value=""  name="product_name" data-validate="required:请输商品名称" />
          <div class="tips"></div>
        </div>
      </div>
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')" class="input w50" value=""  name="product_price" data-validate="required:请输商品价格" />
          <div class="tips"></div>
        </div>
      </div>
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" onkeyup="this.value=this.value.replace(/\D/g,'')"  class="input w50" value=""  name="product_num" data-validate="required:请输商品库存" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <textarea rows="20" cols="20" id="editor_content" name="product_info" style="display:none;"></textarea>

         <script>
        var E = window.wangEditor;
        var editor = new E('#editor');
        editor.customConfig.uploadImgServer = "<?php echo U('Tablet/uploadFile');?>";  // 上传图片到服务器
  ...
  <div class="form-group">
        ...
        <div class="field ">      
         <input type="text" class="input w50" value="" name="product_img" placeholder="输入网络图片地址"  />
         <dd  class="mselector">
